...
> = {
  dhv: {
    ...
    slug: 'dhv',
    image: '/images/products/dhv-trunnion-3pc.jpg',
  ...
  perar: {
    name: 'Perar',
    slug: 'perar',
    image: '/images/products/df-trunnion-automated-perar.jpg',
  ...
  consolidated: {
    ...
    slug: '',
    image: '/images/products/consolidated-safety-clean.webp',
  ...
  masoneilan: {
    ...
    slug: '',
    image: '/images/products/masoneilan-control-clean.webp',
...
export const productCategories: Record<string, ProductCategory> = {
  ...
  'valvulas-bola-trunnion-soldado': {
    ...
    subtypes: [
      ...
      },
      {
        ...
        image: '/images/products/trunnion-soldado-subsea.webp',
        heroImage: '/images/products/trunnion-soldado-subsea-banner.webp',
        standards: ['API 6DSS'],
      },
    ],
  },
  ...
  'valvulas-bola-trunnion-atornillado': {
    ...
    image: '/images/products/dhv-trunnion-2pc-clean.jpg',
    heroImage: '/images/products/hero-trunnion-atornillado.webp',
    sizes: '2" a 48"',
    ...
    subtypes: [
      {
        ...
        image: '/images/products/atornillado-2piezas.webp',
        heroImage: '/images/products/atornillado-2piezas-banner.webp',
        sizes: '2" to 48"',
        pressureClasses: 'ANSI 150-2500',
      },
      {
        ...
        image: '/images/products/atornillado-3piezas.webp',
        heroImage: '/images/products/atornillado-3piezas-banner.webp',
        sizes: '2" to 36"',
        pressureClasses: 'ANSI 150-2500',
      },
    ],
  ...
  'valvulas-bola-flotante': {
    ...
    heroImage: '/images/products/hero-flotante.webp',
    sizes: '1/2" a 12"',
    ...
    subtypes: [
      {
        ...
        image: '/images/products/flotante-estandar.webp',
  ...
  'valvulas-compuerta': {
    ...
    heroImage: '/images/products/hero-compuerta.webp',
    sizes: '2" a 36"',
    pressureClasses: 'ANSI 150–2500',
    ...
    subtypes: [
      {
        ...
        manufacturers: ['dhv'],
        image: '/images/products/compuerta-slab.webp',
        heroImage: '/images/products/compuerta-slab-banner.webp',
        sizes: '2" to 36"',
        pressureClasses: 'ANSI 150-2500',
      },
      {
        ...
        manufacturers: ['dhv'],
        image: '/images/products/compuerta-cuna.webp',
        heroImage: '/images/products/compuerta-cuna-banner.webp',
        sizes: '2" to 24"',
  ...
  'valvulas-globo': {
    ...
    heroImage: '/images/products/hero-globo.webp',
    sizes: '2" a 24"',
    pressureClasses: 'ANSI 150–2500',
    ...
    subtypes: [
      {
        ...
        manufacturers: ['dhv'],
        image: '/images/products/globo-estandar.webp',
        heroImage: '/images/products/globo-estandar-banner.webp',
        sizes: '2" to 24"',
        pressureClasses: 'ANSI 150-2500',
      },
    ],
  ...
  'valvulas-check': {
    ...
    heroImage: '/images/products/hero-check.webp',
    sizes: '2" a 36"',
    pressureClasses: 'ANSI 150–2500',
  ...
  'valvulas-control': {
    ...
    image: '/images/products/masoneilan-control-clean.webp',
    heroImage: '/images/products/hero-control.webp',
    sizes: '1" a 24"',
    pressureClasses: 'ANSI 150–2500',
    ...
    subtypes: [
      {
        ...
        image: '/images/products/control-globo.webp',
        heroImage: '/images/products/control-globo-banner.webp',
        sizes: '1" to 24"',
      },
      {
        slug: 'rotativas',
        ...
        manufacturers: ['masoneilan'],
        image: '/images/products/control-rotativas.webp',
        heroImage: '/images/products/control-rotativas-banner.webp',
      },
    ],
  },
    ...
    subtypes: [
      {
        ...
        image: '/images/products/seguridad-convencional.webp',
        heroImage: '/images/products/seguridad-convencional-banner.webp',
        sizes: '1" to 12"',
      },
      {
        slug: 'balanceada',
        ...
        manufacturers: ['consolidated'],
        image: '/images/products/seguridad-balanceada.webp',
        heroImage: '/images/products/seguridad-balanceada-banner.webp',
      },
    ],
  },
  ...
  'valvulas-neumaticas-solenoides': {
    ...
    image: '/images/products/versa-product-family.webp',
    heroImage: '/images/products/hero-neumaticas-selenoides.webp',
    sizes: '1/4" a 2"',
    ...
    subtypes: [
      {
        ...
        manufacturers: ['versa'],
        image: '/images/products/selenoide-serie-v.webp',
        heroImage: '/images/products/selenoide-serie-v-banner.webp',
      },
      {
        slug: 'piloto-control',
        ...
        manufacturers: ['versa'],
        image: '/images/products/neumatico-direccional.webp',
        heroImage: '/images/products/neumatico-direccional-banner.webp',
      },
      {
        ...
        manufacturers: ['versa'],
        image: '/images/products/paquete-aire.webp',
        heroImage: '/images/products/paquete-aire-banner.webp',
      },
    ],
  },
  ...
  'valvulas-automatizadas': {
    ...
    image: '/images/products/df-trunnion-automated-pair.jpg',
    heroImage: '/images/products/hero-automatizadas.webp',
    sizes: '1" a 48"',
    pressureClasses: 'ANSI 150–2500',
    ...
    subtypes: [
      {
        ...
        image: '/images/products/automatizada-esd.webp',
        heroImage: '/images/products/automatizada-esd-banner.webp',
      },
      {
        ...
        manufacturers: ['masoneilan'],
        image: '/images/products/automatizada-control.webp',
        heroImage: '/images/products/automatizada-control-banner.webp',
      },
    ],
  },
