...
> = {
  dhv: {
    ...
    slug: 'dhv',
    image: '/images/products/dhv-trunnion-3pc-factory.jpg',
...
export const productCategories: Record<string, ProductCategory> = {
  ...
  'valvulas-neumaticas-solenoides': {
    ...
    image: '/images/products/versa-product-family.webp',
    heroImage: '/images/products/versa-csg-316-pair.png',
    sizes: '1/4" a 2"',
    ...
    subtypes: [
      {
        ...
        manufacturers: ['versa'],
        image: '/images/products/versa-csg-316-pair.png',
      },
      {
        slug: 'piloto-control',
      ...
      },
      {
        ...
        manufacturers: ['versa'],
        image: '/images/products/versa-dmap-316.webp',
      },
    ],
  },
