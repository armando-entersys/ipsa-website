...
export const productCategories: Record<string, ProductCategory> = {
  ...
  'valvulas-bola-trunnion-soldado': {
    ...
    heroImage: '/images/products/df-fully-welded-white.jpg',
    sizes: '2" a 48"',
    ...
    subtypes: [
      {
        ...
        image: '/images/products/df-fully-welded-white.jpg',
        sizes: '4" to 48"',
      },
      {
        slug: 'aerea',
      ...
      },
      {
        ...
        image: '/images/products/df-massive-body-machining.jpg',
        standards: ['API 6DSS'],
      },
    ],
  },
  ...
  'valvulas-bola-trunnion-atornillado': {
    ...
    heroImage: '/images/products/df-trunnion-blue-factory.jpg',
    sizes: '2" a 48"',
  ...
  'valvulas-bola-flotante': {
    ...
    subtypes: [
      ...
      },
      {
        ...
        manufacturers: ['della-foglia'],
        image: '/images/products/df-trunnion-bore-pair.jpg',
        sizes: '2" to 24"',
      },
      {
        slug: 'criogenica',
        ...
        manufacturers: ['della-foglia'],
        image: '/images/products/df-stainless-row-factory.jpg',
      },
    ],
  },
  ...
  'valvulas-compuerta': {
    ...
    heroImage: '/images/products/dhv-gate-valves-warehouse.png',
    sizes: '2" a 36"',
    pressureClasses: 'ANSI 150–2500',
    ...
    subtypes: [
      ...
      },
      {
        ...
        manufacturers: ['dhv'],
        image: '/images/products/dhv-gate-valves-warehouse.png',
        sizes: '2" to 24"',
  ...
  'valvulas-check': {
    ...
    heroImage: '/images/products/dhv-dbb-factory.jpg',
    sizes: '2" a 36"',
    pressureClasses: 'ANSI 150–2500',
  ...
  'valvulas-automatizadas': {
    ...
    heroImage: '/images/products/df-trunnion-automated-perar.jpg',
    sizes: '1" a 48"',
    pressureClasses: 'ANSI 150–2500',
