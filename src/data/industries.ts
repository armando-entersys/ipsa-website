...
export const industries: Industry[] = [
  {
    ...
    description: {
      es: 'Soluciones integrales para la industria petrolera en los segmentos upstream, midstream y downstream. Valvulas, actuadores y sistemas de control para las condiciones mas exigentes.',
    ...
    longDescription: {
      es: 'IPSA ha sido proveedor de la industria petrolera mexicana e internacional por mas de 30 anos. Nuestro profundo conocimiento de las condiciones extremas de presion, temperatura y corrosion que enfrentan las instalaciones petroleras nos permite ofrecer las soluciones mas adecuadas para cada aplicacion. Trabajamos con los principales operadores como PEMEX, y contamos con experiencia en plataformas offshore, refineries, plantas de proceso y ductos de transporte.',
    ...
    segments: {
      es: [
        'Upstream - Exploracion y produccion',
        'Midstream - Transporte y almacenamiento',
        'Downstream - Refinacion y petroquimica',
      ],
      en: [
    ...
    challenges: [
      {
        title: {
          es: 'Presion y temperatura extremas',
          en: 'Extreme pressure and temperature',
        },
        description: {
          es: 'Las aplicaciones upstream y de refineria enfrentan presiones que superan los 10,000 psi y temperaturas desde crogenicas hasta mas de 500 grados C.',
      ...
      {
        title: {
          es: 'Corrosion y servicio amargo (H2S)',
          en: 'Corrosion and sour service (H2S)',
        },
        description: {
          es: 'La presencia de acido sulfhidrico (H2S), CO2 y cloruros en el crudo requiere materiales resistentes a la corrosion y al agrietamiento bajo esfuerzo.',
      ...
      {
        title: {
          es: 'Seguridad y proteccion ambiental',
          en: 'Safety and environmental protection',
        },
        description: {
          es: 'Los derrames y fugas fugitivas representan riesgos criticos para la seguridad del personal y el medio ambiente, requiriendo tecnologias de sello avanzadas.',
    ...
    solutions: [
      {
        title: {
          es: 'Valvulas API 6D y API 6A',
          en: 'API 6D and API 6A Valves',
        },
        description: {
          es: 'Valvulas de bola trunnion mounted y compuerta disenadas y fabricadas bajo los estandares API 6D y API 6A, con pruebas en fabrica y certificacion completa.',
      ...
      },
      {
        ...
        description: {
          es: 'Seleccion de materiales conforme a NACE MR0175 incluyendo acero inoxidable duplex, super duplex, Inconel, Monel y otras aleaciones especiales para servicio amargo y corrosivo.',
      ...
      },
      {
        ...
        description: {
          es: 'Diseno e implementacion de sistemas ESD con actuadores auto-contenidos, paneles de control y logica de seguridad conforme a IEC 61511 y API 14C.',
  ...
  },
  {
    ...
    description: {
      es: 'Soluciones especializadas para la industria de procesamiento de aceites. Valvulas y sistemas de control para el manejo de fluidos viscosos a altas temperaturas.',
    ...
    longDescription: {
      es: 'IPSA provee valvulas, actuadores y sistemas de control especificamente seleccionados para las necesidades de la industria de procesamiento de aceites. Nuestro enfoque se centra en la seleccion de materiales adecuados para temperaturas elevadas y fluidos viscosos, asi como en sistemas de control de precision que permiten regular con exactitud los parametros criticos del proceso.',
    ...
    challenges: [
      {
        ...
        description: {
          es: 'Los procesos de refinacion y tratamiento de aceites operan a temperaturas elevadas que requieren materiales con alta resistencia termica y sellos especiales.',
      ...
      },
      {
        ...
        description: {
          es: 'El manejo de aceites de alta viscosidad genera retos en el dimensionamiento de valvulas, seleccion de actuadores y configuracion de sistemas de control.',
    ...
    solutions: [
      {
        ...
        description: {
          es: 'Seleccion de aceros aleados, empaques de grafito expandido y sellos de PTFE reforzado para servicio a altas temperaturas. Tratamientos termicos especiales y recubrimientos anti-desgaste.',
      ...
      {
        title: {
          es: 'Sistemas de control de precision',
          en: 'Precision control systems',
        },
        description: {
          es: 'Valvulas de control con posicionadores digitales de alta resolucion, instrumentacion inteligente y comunicacion HART/Fieldbus para control preciso de flujo y temperatura.',
  ...
  },
  {
    ...
    description: {
      es: 'Soluciones para procesamiento, transporte y distribucion de gas natural. Valvulas con sello hermetico, baja emision fugitiva y capacidad criogenica.',
    ...
    longDescription: {
      es: 'IPSA provee soluciones completas para la cadena de valor del gas natural, desde plantas de procesamiento hasta redes de distribucion. Nuestras valvulas y sistemas de control estan disenados para garantizar un sello hermetico, minimizar las emisiones fugitivas conforme a ISO 15848 y operar en condiciones criogenicas. Ofrecemos configuraciones de doble bloqueo y purga (DBB) para maxima seguridad en aplicaciones de gas.',
    ...
    challenges: [
      {
        title: {
          es: 'Sello hermetico y emisiones fugitivas',
          en: 'Tight shutoff and fugitive emissions',
        },
        description: {
          es: 'Las regulaciones ambientales cada vez mas estrictas exigen valvulas con niveles de fuga extremadamente bajos y certificacion de emisiones fugitivas.',
      ...
      {
        title: {
          es: 'Condiciones criogenicas',
          en: 'Cryogenic conditions',
        },
        description: {
          es: 'Las plantas de GNL y los procesos de fraccionamiento operan a temperaturas tan bajas como -196 grados C, requiriendo materiales y disenos especiales.',
      ...
      },
      {
        ...
        description: {
          es: 'Los gasoductos de alta presion requieren valvulas con doble barrera de sellado y capacidad de bloqueo y purga para aislamiento seguro durante mantenimiento.',
    ...
    solutions: [
      {
        title: {
          es: 'Certificacion ISO 15848',
          en: 'ISO 15848 Certification',
        },
        description: {
          es: 'Valvulas con certificacion ISO 15848 de emisiones fugitivas, empaque vivo de grafito expandido y diseno de sello avanzado para maxima hermeticidad.',
      ...
      {
        title: {
          es: 'Valvulas criogenicas',
          en: 'Cryogenic valves',
        },
        description: {
          es: 'Valvulas de bola y compuerta con extension de vastago, materiales austeniticos y pruebas criogenicas conforme a BS 6364 y MSS SP-134.',
      ...
      },
      {
        ...
        description: {
          es: 'Valvulas de doble bloqueo y purga (DBB) que proporcionan doble barrera de aislamiento con capacidad de verificacion de sellos a traves de la cavidad central.',
